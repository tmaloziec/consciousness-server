...
- **Plugins** — extend consciousness-server with new tools and modes (see [Plugin API in README](README.md#plugins))
...
- **Adding heavy dependencies** — consciousness-server aims to stay lean
